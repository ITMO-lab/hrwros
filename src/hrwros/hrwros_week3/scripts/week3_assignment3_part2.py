...
if __name__ == '__main__':
    ...
    turtlebot_robot1_goal.target_pose.pose.position.x = <Add-second-goal-Position-X>
    turtlebot_robot1_goal.target_pose.pose.position.y = <Add-second-goal-Position-Y>
